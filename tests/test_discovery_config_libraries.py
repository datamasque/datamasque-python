...
@pytest.fixture
def sample_library_list_response() -> dict[str, Any]:
...
def test_list_discovery_config_libraries_pagination(client: DataMasqueClient) -> None:
    page1 = {
        "count": 3,
        "next": "http://test-server/api/discovery/config-libraries/?limit=2&offset=2",
        "previous": None,
        "results": [
            {
                "id": LIBRARY_ID_1,
    ...
    page2 = {
        "count": 3,
        "next": None,
        "previous": "http://test-server/api/discovery/config-libraries/?limit=2",
        "results": [
            {
